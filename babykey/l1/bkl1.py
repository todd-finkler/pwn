...
def main():
    ...
    # It's reasonably easy to tell from looking at the program in ghidra that the key will
    ...
    simgr.move(from_stash='deadended', to_stash='password', filter_func=lambda s: 'Correct! Here is your flag:' in s.posix.dumps(1))
